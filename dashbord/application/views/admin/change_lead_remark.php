      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <?php endif ?></center>
             <form action="<?php echo base_url('Admin/change_lead_remark/').$res->id ?>" enctype="multipart/form-data" method="post" id="contact-form">
                ...
                <div class="card-body">
                  ...
                  <input type="text" name="name" class="form-control" placeholder="Name" value="<?php echo $res->name?>">
                       ...
                       <input type="hidden" name="user_id" class="form-control" placeholder="Name" value="<?php echo $this->session->userdata("id")?>">
                </div>
              </div>
               <div class="col-md-6 form-group">
            ...
            <div class="row">
                  ...
                  <textarea class="form-control" name="remarks" rows="2"><?php echo $res->remarks?></textarea>
                </div>
              </div>
            </div>     
        </div>
