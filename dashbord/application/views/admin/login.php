...
<head>
  ...
  <!--favicon-->
  <link rel="icon" href="<?php echo base_url()?>/dashbord/assets/images/favicon.ico" type="image/x-icon">
  <!-- Bootstrap core CSS-->
		...
		<div class="card-body">
		 <div class="card-content p-2">
		 	<div class="text-center">
		 			<img src="<?=base_url()?>admin_css/planet.png" height="80" width="80" alt="logo icon">
		 	</div>

		  <div class="card-title text-uppercase text-center py-3">Sign In</div>
		    <form class="login100-form validate-form" action="<?php echo base_url('admin/index') ?>" method="post">
