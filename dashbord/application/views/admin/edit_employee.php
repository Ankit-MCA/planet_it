      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <?php endif ?></center>
                        <form action="<?php echo base_url('Admin/edit_employee/'.$data->id) ?>" enctype="multipart/form-data" method="post"> 
                <div class="card-body">
                   <div class="row">
             ...
             <div class="row">
               ...
               <div class="col-md-3 form-group">
                  ...
                  <input type="text" name="address" value="<?php echo $data->address ?>" required="" class="form-control" placeholder="">
                   ...
                   <div class="col-md-3 form-group">
                    <label for="exampleInputPassword1">PAN/Aadhar No</label>
                  <div class="input-group mb-3">
                  <div class="input-group-prepend">
                    <span class="input-group-text"><i class="fas fa-name">N</i></span>
                  </div>
                  <input type="text" name="pan_no" required="" value="<?php echo $data->pan_no ?>" class="form-control" placeholder="">
                </div>
              </div>
               <div class="col-md-3 form-group">
             ...
             <div class="row">
               ...
               <div class="col-md-3 form-group">
                  ...
                  <input type="text" name="ifsc_code" value="<?php echo $data->ifsc_code ?>" required="" class="form-control" placeholder="Mobile no">
                </div>
              </div>
                     <div class="col-md-3 form-group">
