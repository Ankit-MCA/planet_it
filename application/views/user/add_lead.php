      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <?php endif ?></center>
             <form action="<?=base_url()?>User/add_lead" enctype="multipart/form-data" method="post" id="contact-form">
                <div class="card-body">
                   <div class="row">
               ...
               <div class="col-md-3 form-group">
                  ...
                  <input type="text" name="other_no" class="form-control" placeholder="">
                </div>
              </div>
            </div>     
             ...
             <div class="row">
                  ...
                  <input type="text" name="enquiry"  class="form-control" placeholder="">
                </div>
              </div>
               <div class="col-md-3 form-group">
                  ...
                  <input type="text" name="location"  class="form-control" placeholder="">
                   <input type="hidden" name="today_date" class="form-control" placeholder="Date" value="<?php echo date('Y-m-d') ?>">
                </div>
              </div>
                   <div class="col-md-3 form-group">
                  ...
                  <input type="date" name="follow_up_date" class="form-control" placeholder="">
                </div>
              </div>
               <div class="col-md-3 form-group">
             ...
             <div class="row">
                  ...
                  <input type="text" name="refer_by" class="form-control" placeholder="">
                </div>
              </div>
               <div class="col-md-3 form-group">
                  ...
                  <input type="text" name="stage" class="form-control" placeholder="">
                </div>
              </div>
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
            ...
            <div class="col-lg-2">
              <form action="<?=base_url("User/assign_lead")?>" method="post">
           ...
           <div class="form-group">
            ...
            <form action="<?php echo base_url('User/change_status/') ?>" enctype="multipart/form-data" method="post">
            ...
            <option value="0">Select</option>
              ...
              <option value="Not Contact">Not Contact</option>
                  ...
                  <button type="submit" class="btn btn-flat btn-success accept" style="background-color:#4caf50; color:white; border-radius:5px; padding:5px 11px; font-size: 14px;">Update</button>
                       ...
                       <td>
                     <a href="<?php echo base_url('User/edit_lead/').$value->id ?>" class="btn btn-flat btn-success rounded-circle" style="background-color:#4caf50; color:white; border-radius:5px; padding:5px 11px; font-size: 14px;" ><i class="fa fa-edit"></i></a>

                    <a href="<?php echo base_url('User/delete_lead/').$value->id ?>" class="btn btn-flat btn-danger rounded-circle" style="background-color:#CC0000; color:white; border-radius:5px; padding:5px 11px; font-size: 14px;" ><i class="fa fa-trash"></i></a>

                  
                    <a href="<?php echo base_url('User/change_lead_remark/').$value->id ?>" class="btn btn-flat btn-success rounded-circle" style="background-color:#4caf50; color:white; border-radius:5px; padding:5px 11px; font-size: 14px;" ><i class="fa fa-plus"></i></a>

                      <a href="<?php echo base_url('User/view_remark/').$value->id ?>" class="btn btn-flat btn-success rounded-circle" style="background-color:#4caf50; color:white; border-radius:5px; padding:5px 11px; font-size: 14px;" ><i class="fa fa-eye"></i></a>
