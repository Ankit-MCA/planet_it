...
">
              ...
              <div class="row">
                <div class="col-12">
                  <h4>
                     <img src="<?=base_url()?>dashbord/logo.jgp" style="color:#f6f6"   height="60" width="80" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">  Adyone Communication Pvt. Ltd.
                     <?php  $date=date('d-m-Y'); ?>
