          ...
          <div class="col-sm-3">
           ...
           <div class="col-sm-4">
            <?php $id= $this->uri->segment(3); ?>
             <a href="<?php echo base_url('Admin/all_invoice/').$id ?>"rel="noopener"  class="btn btn-default"><i class="fas fa-file"></i> With out GST</a>
              <a href="<?php echo base_url('Admin/all_invoice_with_gst/').$id ?>" rel="noopener"  class="btn btn-default"><i class="fas fa-file"></i> With GST</a>
          </div>
                ...
                <div class="col-6">
                  ...
                  <div class="table-responsive">
                    ...
                    <!--   <tr>
                      ...
                      <tr>
                          <?php $total_gst=$paye*18/100; ?>
                        <th>Total GST(18%)</th>
                         <td><?php echo $total_gst ?></td>
                      </tr>
                      <tr>
                        <th>Total Recive Amount:</th>
                        <td><?php echo $paye ?></td>
                      </tr>
                      <tr>
                        <th>Project Cost:</th>
                      ...
                      <tr>
                        <th>Balance:</th>
                        <td><b style="color:"><u><?php echo $total_cost+$total_gst-$recive_cost  ?></u></b></td>
                      </tr>
                    </table>
                  </div>
                </div>
