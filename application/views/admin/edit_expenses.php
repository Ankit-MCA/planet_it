      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <?php endif ?></center>
                <form action="<?php echo base_url('Admin/edit_expenses/'.$data1->id) ?>" enctype="multipart/form-data" method="post"> 
                <div class="card-body">
                   <div class="row">
                  ...
                  <input type="text" name="amount" required="" value="<?php echo $data1->amount ?>" class="form-control" placeholder="">
                </div>
              </div>
               <div class="col-md-3 form-group">
                  ...
                  <input type="date" name="date" required="" value="<?php echo $data1->date ?>" class="form-control" placeholder="">
                </div>
              </div>
                   <div class="col-md-3 form-group">
                  ...
                  <input type="text" name="remark" required="" value="<?php echo $data1->remark ?>" class="form-control" placeholder="">
                </div>
              </div>
