        ...
        <div class="row mb-2">
          <div class="col-sm-6">
              <h6>
                  ...
                  ?>
            <a href="<?php echo base_url('Admin/monthly_data/'.$emp_id.'/'.$month_id.'') ?>" class="pull-right btn btn-info btn-xs" style="margin: 2px;"><i class="fa fa-mail-reply"></i> Go Back </a></h6>
          </div>
          <div class="col-sm-6">
           ...
           //print_r($full_day_salary);die;
            $half_day_salary=$full_day_salary/2;
             ...
             // echo $this->db->last_query();die;
              ...
              $this->db->where('YEAR(created_at)', date('Y'));
              $this->db->where('name', $name);
              $this->db->where('date >', '2021-12-23');
              $this->db->where('in_time >', '10:30');
              $this->db->from("attendance");
              $punishment2= $this->db->count_all_results();
              
             // echo $this->db->last_query();die;
              
               $punishment_val2=$punishment2*$half_day_salary;
               
              // print_r($punishment_val2);die;
              
            //   $punishment_amount=$punishment_val+$punishment_val1 +$punishment_val2;
            
             $punishment_amount=$punishment_val+$punishment_val1;
              
              //print_r($punishment_amount);die;
