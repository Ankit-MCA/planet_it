    ...
    <section class="content-header">
      ...
      <div class="container-fluid">
        ...
        <ul class="nav nav-pills">
          ...
          <li class="nav-item">
           <h6><b> <a href="<?php echo base_url('Admin/monthly_data/'.$emp_id.'/'.$month.'') ?>" class="pull-right btn btn-info btn-xs" style="margin: 8px;"><i class="fa fa-mail-reply"></i><?php echo $value->name ?></a></b></h6>
          </li>
           <?php endforeach ?>
                <?php endif ?>
        </ul>
      ...
      <div class="container-fluid">
        ...
        <ul class="nav nav-pills">
          <?php if (!empty($data1)):?>
            ...
            <?php $month= $value->month; ?>
          <li class="nav-item">
           <h6><b> <a href="<?php echo base_url('Admin/salaey_detials/'.$emp_id.'/'.$month.'') ?>" class="pull-right btn btn-info btn-xs" style="margin: 8px;"><i class="fa fa-mail-reply"></i><?php echo $value->name ?></a></b></h6>
          </li>
           <?php endforeach ?>
                  <?php endif ?>
        </ul>
      ...
      <div class="container-fluid">
        ...
        <ul class="nav nav-pills">
          <?php if (!empty($data1)):?>
            ...
            <?php $month= $value->month; ?>
          <li class="nav-item">
           <h6><b> <a href="<?php echo base_url('Admin/salary_slip/'.$emp_id.'/'.$month.'') ?>" class="pull-right btn btn-info btn-xs" style="margin: 8px;"><i class="fa fa-mail-reply"></i><?php echo $value->name ?></a></b></h6>
          </li>
           <?php endforeach ?>
                  <?php endif ?>
        </ul>
                        ...
                        <div class="modal-content">
                          <div class="modal-header">
                            ...
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                             ...
                             // print_r($res);
                              ?>
           <form action="<?=base_url()?>Admin/edit_attendance" enctype="multipart/form-data" method="post" id="contact-form">
