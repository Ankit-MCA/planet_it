     ...
     <form action="<?php echo base_url('Admin/edit_complet_lead/'.$data->id) ?>" enctype="multipart/form-data" method="post" id="contact-form">
                  ...
                  <div class="input-group-prepend">
                    <span class="input-group-text"><i class="fas fa-location">ST</i></span>
                              ...
                              <select name="server_time" class="form-control" >
                                  <option value="Monthly" <?php echo ($data->server_time == 'Monthly')?'selected="selected"':''; ?>> Monthly</option>
                                  <option value="Quarterly" <?php echo ($data->server_time == 'Quarterly')?'selected="selected"':''; ?>> Quarterly</option>
                                  <option value="Half-yearly" <?php echo ($data->server_time == 'Half-yearly')?'selected="selected"':''; ?>> Half-yearly</option>
                                   <option value="Yearly" <?php echo ($data->server_time == 'Yearly')?'selected="selected"':''; ?>> Yearly</option>
                                </select> 
                 <!--<select name="server_time" class="form-control" required="" value="<?php echo $data->server_time ?>">-->
                 <!--    <option value="">Select </option>-->
                 <!--     <option value="Monthly">Monthly </option>-->
                 <!--     <option value="Yearly">Yearly hafley server </option>-->
             ...
             <div class="row">
               <div class="col-md-3 form-group">
                  ...
                  <select name="maintinace_time" class="form-control" >
                                  <option value="Monthly" <?php echo ($data->server_time == 'Monthly')?'selected="selected"':''; ?>> Monthly</option>
                                   <option value="Yearly" <?php echo ($data->server_time == 'Yearly')?'selected="selected"':''; ?>> Yearly</option>
                                </select> 
               ...
               <div class="col-md-3 form-group">
                  ...
                  <select name="domain_time" class="form-control" >
                                  <option value="1 Year" <?php echo ($data->server_time == '1 Year')?'selected="selected"':''; ?>> 1 Year</option>
                                   <option value="2 Year" <?php echo ($data->server_time == '2 Year')?'selected="selected"':''; ?>> 2 Year</option>
                                </select> 
               ...
               <div class="row">
                   <div class="col-md-3 form-group">
                     <label for="exampleInputPassword1">Email Cost*</label>
                  <div class="input-group mb-3">
                  <div class="input-group-prepend">
                    <span class="input-group-text"><i class="fas fa-note">N</i></span>
                  </div>
                   <input type="text" name="email_cost" class="form-control" placeholder="Email Cost " value="<?php echo $data->email_cost ?>">
                </div>
              </div>
                   <div class="col-md-3 form-group">
              ...
              <!-- <div class="col-md-3 form-group">-->
              <!--       <label for="exampleInputPassword1">Email Time</label>-->
              <!--    <div class="input-group mb-3">-->
              <!--    <div class="input-group-prepend">-->
              <!--      <span class="input-group-text"><i class="fas fa-Stage">S</i></span>-->
              <!--    </div>-->
              <!--  <select name="email_time" class="form-control" required="" value="<?php echo $data->email_time ?>">-->
              <!--        <option value="">Select </option>-->
              <!--         <option value="1 Year">1 Year </option>-->
              <!--          <option value="2 Year">2 Year </option>-->
              <!--      </select>-->
            ...
            <div class="row">
                   <div class="col-md-3 form-group">
                     <label for="exampleInputPassword1">Add On Point*</label>
                  <div class="input-group mb-3">
                  <div class="input-group-prepend">
                    <span class="input-group-text"><i class="fas fa-note">T</i></span>
                  </div>
                   <input type="text" name="add_on_point" class="form-control" placeholder="Title " value="<?php echo $data->add_on_point ?>">
                </div>
              </div>
                   <div class="col-md-3 form-group">
                     <label for="exampleInputPassword1">Add On Cost</label>
                  <div class="input-group mb-3">
                  <div class="input-group-prepend">
                    <span class="input-group-text"><i class="fas fa-money-check-alt"></i></span>
                  </div>
                  <input type="text" name="add_on_cost" class="form-control" placeholder="cost" value="<?php echo $data->add_on_cost ?>">
                </div>
              </div>
