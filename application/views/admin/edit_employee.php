          ...
          <div class="col-md-12">
            ...
            <?php endif ?></center>
               ...
               <div class="col-md-3 form-group">
                  ...
                  <input type="text" name="other_no" required="" value="<?php echo $data->other_no ?>" class="form-control" placeholder="">
                </div>
              </div>
             ...
             <div class="row">
                  ...
                  <div class="input-group mb-3">
                  <div class="input-group-prepend">
                    <span class="input-group-text"><i class="fas fa-name">A.N</i></span>
                  </div>
