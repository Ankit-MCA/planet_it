      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <?php endif ?></center>
      <form action="<?php echo base_url('Admin/add_maintenance_costumers') ?>" enctype="multipart/form-data" method="post">
                <div class="card-body">
                   <div class="row">
               ...
               <div class="col-md-3 form-group">
                  ...
                  <div class="input-group-prepend">
                    ...
                    <?php $pay = $this->am->selectrow('maintenance_costumers',array('user_id'=>$data->id)); 
                             // print_r($res);
                              ?>
                   <?php if(!empty($total_cost))
                   {
                       ?>
                    <input type="text" name="maintenance_cost" class="form-control" placeholder="Total Payment" value="<?php echo $total_cost ?>">
                        <?php 
                   }
                   else{
                       ?>
